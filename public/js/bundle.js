      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Logging out error. Try it again !!!');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " is updated successfully"));
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return axios({
              method: 'GET',
              url: "api/v1/cart/addToCart/".concat(tourId)
            });
...
if ($formLogin) {
  $formLogin.addEventListener('submit', /*#__PURE__*/function () {
...
if ($cardContainer) {
  $cardContainer.addEventListener('click', /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(e) {
      var $addToCart, tourId;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              tourId = $addToCart.dataset.tourId;
              $addToCart.textContent = 'Adding...';
              _context4.next = 6;
              return (0, _cart.addToCart)(tourId);
